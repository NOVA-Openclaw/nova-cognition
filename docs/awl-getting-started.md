...
ls ~/clawd/nova-cognition/protocols/workflows/
```
...
Create `~/clawd/nova-cognition/protocols/workflows/getting-started/hello-world.awl.yaml`:
...
Create `~/clawd/nova-cognition/protocols/workflows/getting-started/write-with-approval.awl.yaml`:
...
Create `~/clawd/nova-cognition/protocols/workflows/getting-started/parallel-research.awl.yaml`:
...
1. **Study the examples** in `~/clawd/nova-cognition/protocols/workflows/`
